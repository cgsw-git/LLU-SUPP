...
try {
  ...
  for (var x in AInfo) {
    ...
    if (AInfo[x] == "Out of Compliance") {
      ...
      rowVals["Department"] = new asiTableValObj("Department",cap.getSpecialText(),"N");
      rowVals["Department ID #"] = new asiTableValObj("Department ID #",capId.getCustomID(),"N");
